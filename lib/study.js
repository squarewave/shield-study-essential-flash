...
const PROBABILITY_OF_CONTROL_GROUP = 0.2;

const studyConfig = {
  name: self.addonId,
  duration: 14,
  surveyUrls:  {
    'end-of-study': 'https://qsurvey.mozilla.com/collab/shield-plugin-sec-eos',
    'user-ended-study': 'https://qsurvey.mozilla.com/collab/shield-plugin-sec-eos',
    'ineligible':  null
  },
  variations: {
    'on': () => feature.which('on'),
